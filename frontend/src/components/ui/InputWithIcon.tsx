  ...
  return (
    <div className="space-y-2">
        ...
        <div className="relative mt-1">
            <div className="absolute left-3 top-1/2 -translate-y-1/2 text-main/40">
                {icon}
            </div>
            <input ref={ref} {...props} type={type === "password" ? (showPassword ? "text" : "password") : type} className={`pl-12 h-10 w-full rounded-md text-sm border border-line focus:border-primary focus:ring-4 focus:ring-primary/20 ${props.className}`} />
