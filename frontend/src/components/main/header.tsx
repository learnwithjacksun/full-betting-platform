          ...
          <div className="center gap-2">
            ...
            {user && (
              <div className="center gap-2 md:gap-4">
                {/* Link to my-bets page - shows placed bets count */}
                <Link
                  to="/bets"
                  className="center relative gap-2 border border-line bg-foreground md:h-10 md:w-10 h-8 w-8 rounded-full"
                >
                  <Ticket className="w-4 h-4" />
                  {betsCount > 0 && (
                    <div className="absolute -top-2 -right-2 bg-red-600 text-white w-5 h-5 center rounded-full font-space text-xs font-bold">
                      {betsCount}
                    </div>
                  )}
                </Link>
